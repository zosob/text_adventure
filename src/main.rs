                ...
                match command.as_str() {
                    ...
                    "use potion" => {
                        if let Some(pos) = player
                            .inventory
                            .iter()
                            .position(|i| matches!(i, Item::Potion))
                        {
                            player.health += 20;
                    ...
                    "look" => {
                        ...
                        if room.has_enemy {
                            ...
                            combat::fight(&mut player, &mut enemy);
                        }
                    }
                    "quit" => {
...
fn setup_rooms() -> HashMap<String, Room> {
    ...
    rooms.insert(
        ...
        Room {
            ...
            exits: HashMap::from([("north".to_string(), "hallway".to_string())]),
            items: vec![],
            has_enemy: false,
        },
    );
    ...
    rooms.insert(
        ...
        Room {
            ...
            exits: HashMap::from([("west".to_string(), "hallway".to_string())]),
